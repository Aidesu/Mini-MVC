    ...
    <body>
        <main>
            ...
            <form action="" method="post">
                ...
                <input type="text" name="firstName" placeholder="Enter a first name here ..."><br>
                <label for="lastName">Last name : </label>
                <input type="text" name="lastName" placeholder="Enter a last name here ..."><br>
                ...
                <input type="textarea" name="profilePicture" id="inputProfilePic" placeholder="Enter image URL here ...">
